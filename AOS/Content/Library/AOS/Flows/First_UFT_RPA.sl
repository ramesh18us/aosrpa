...
operation:
  ...
  inputs:
    ...
    - url
  sequential_action:
    gav: 'com.microfocus.seq:AOS.Flows.First_UFT_RPA:1.0.0'
    skills:
      - Web
    settings:
      windows:
    ...
    steps:
      ...
      - step:
          ...
          action: Navigate
          default_args: '"http://localhost:8080/"'
    ...
    - object:
        ...
        child_objects:
          - object:
              ...
              class: Page
              visual_relations: ''
              last_update_time: 'Wednesday, June 3, 2020 5:48:04 PM'
              ...
              child_objects:
                ...
                - object:
                    ...
                    properties:
                      ...
                      - property:
                          value:
                            value: rameshn My account My orders Sign out
                            regular_expression: false
                          name: text
                          hidden: true
                          read_only: true
