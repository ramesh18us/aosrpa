...
operation:
  ...
  inputs:
    ...
    - Categories: Test
  sequential_action:
    gav: 'com.microfocus.seq:AOS.buy_item_act:1.0.0'
    skills:
      - Web
    settings:
      windows:
    ...
    steps:
      ...
      - step:
          ...
          highlight_id: 'Browser("Google").Page("Advantage Shopping").Link("UserMenu")'
      - step:
          id: '6'
          ...
          highlight_id: 'Browser("Google").Page("Advantage Shopping").WebEdit("username")'
      ...
      - step:
          ...
          highlight_id: 'Browser("Google").Page("Advantage Shopping").WebEdit("password")'
      ...
      - step:
          ...
          highlight_id: 'Browser("Google").Page("Advantage Shopping").WebButton("sign in btnundefined")'
      - step:
          id: '9'
          object_path: 'Browser("Google").Page("Advantage Shopping").Link("tabletsTxt")'
          action: Click
          snapshot: ".\\Snapshots\\ssf9.html"
          highlight_id: 'Browser("Google").Page("Advantage Shopping").Link("tabletsTxt")'
      - step:
          id: '10'
          object_path: 'Browser("Google").Page("Advantage Shopping").WebElement("HP Elite x2 1011 G1 Tablet")'
          action: Click
          snapshot: ".\\Snapshots\\ssf10.html"
          highlight_id: 'Browser("Google").Page("Advantage Shopping").WebElement("HP Elite x2 1011 G1 Tablet")'
      - step:
          id: '11'
          object_path: 'Browser("Google").Page("Advantage Shopping").WebButton("save_to_cart")'
          action: Click
          snapshot: ".\\Snapshots\\ssf11.html"
          highlight_id: 'Browser("Google").Page("Advantage Shopping").WebButton("save to cart")'
      - step:
          id: '12'
          object_path: 'Browser("Google").Page("Advantage Shopping").WebButton("check_out_btn")'
          action: Click
          snapshot: ".\\Snapshots\\ssf12.html"
          highlight_id: 'Browser("Google").Page("Advantage Shopping").WebButton("check out btn")'
      - step:
          id: '13'
          object_path: 'Browser("Google").Page("Advantage Shopping").WebButton("next_btn")'
          action: Click
          snapshot: ".\\Snapshots\\ssf13.html"
          highlight_id: 'Browser("Google").Page("Advantage Shopping").WebButton("next btn")'
      - step:
          id: '14'
          object_path: 'Browser("Google").Page("Advantage Shopping").WebElement("SafePay username")'
          action: Click
          snapshot: ".\\Snapshots\\ssf14.html"
          highlight_id: 'Browser("Google").Page("Advantage Shopping").WebElement("SafePay username")'
      - step:
          id: '15'
          ...
          highlight_id: 'Browser("Google").Page("Advantage Shopping").WebEdit("safepay username")'
          args: 'Parameter("username")'
      - step:
          id: '16'
          ...
          highlight_id: 'Browser("Google").Page("Advantage Shopping").WebEdit("safepay password")'
          args: 'Parameter("password")'
      - step:
          id: '17'
          ...
          highlight_id: 'Browser("Google").Page("Advantage Shopping").WebCheckBox("save safepay")'
      - step:
          id: '18'
          object_path: 'Browser("Google").Page("Advantage Shopping").WebButton("pay_now_btn_SAFEPAY")'
          action: Click
          snapshot: ".\\Snapshots\\ssf18.html"
          highlight_id: 'Browser("Google").Page("Advantage Shopping").WebButton("pay now btn SAFEPAY")'
      - step:
          id: '19'
          object_path: 'Browser("Google").Page("Advantage Shopping").WebElement("$1,279.00")'
          action: Output
          default_args: 'CheckPoint("price")'
      - step:
          id: '20'
          object_path: 'Browser("Google").Page("Advantage Shopping").Link("UserMenu_2")'
          action: Click
          snapshot: ".\\Snapshots\\ssf19.html"
          highlight_id: 'Browser("Google").Page("Advantage Shopping").Link("UserMenu 2")'
      - step:
          id: '21'
          object_path: 'Browser("Google").Page("Advantage Shopping").Link("Link")'
          action: Click
          snapshot: ".\\Snapshots\\ssf20.html"
          highlight_id: 'Browser("Google").Page("Advantage Shopping").Link("Link")'
  outputs:
    - price:
        robot: true
        value: '${price}'
        ...
        child_objects:
          - object:
              ...
              properties:
                ...
                - property:
                    value:
                      value: 'https://www.bing.com/search?q=localhost%3A8080&src=IE-SearchBox&FORM=IESR3N'
                      regular_expression: false
                    name: url
                    hidden: true
                    read_only: true
                ...
                - property:
                    value:
                      value: '&q=localhost%3A8080&src=IE-SearchBox&FORM=IESR3N'
                      regular_expression: false
              ...
              class: Page
              visual_relations: ''
              last_update_time: 'Wednesday, June 3, 2020 8:48:15 PM'
          ...
          - object:
              ...
              properties:
                ...
                - property:
                    value:
                      value: 'https://www.google.com/?gws_rd=ssl#spf=1591216915805'
                      regular_expression: false
                    name: url
                    hidden: true
                    read_only: true
                ...
                - property:
                    value:
                      value: '&gws_rd=ssl#spf=1591216915805'
                      regular_expression: false
                    name: non user-input in get data
                    hidden: true
                    read_only: true
              ...
              child_objects:
                - object:
                    ...
                    properties:
                      ...
                      - property:
                          value:
                            value: '//DIV[@id="paymentMethod"]/DIV[1]/DIV[2]/SEC-FORM[1]/SEC-VIEW[1]/DIV[1]/LABEL[1]'
                            regular_expression: false
                          name: _xpath
                          hidden: true
                          read_only: true
                ...
                - object:
                    ...
                    properties:
                      ...
                      - property:
                          value:
                            value: HP USB 3 BUTTON OPTICAL MOUSE
                            regular_expression: false
                          name: innertext
                          hidden: false
                          read_only: false
                      ...
                      - property:
                          value:
                            value: '//DIV[3]/SECTION[1]/ARTICLE[1]/DIV[3]/DIV[1]/DIV[1]/DIV[2]/UL[1]/LI[1]/P[1]/A[1]'
                            regular_expression: false
                          name: _xpath
                          hidden: true
                          read_only: true
                ...
                - object:
                    ...
                    properties:
                      ...
                      - property:
                          value:
                            value: '//LOGIN-MODAL[1]/DIV[1]/DIV[1]/DIV[3]/SEC-FORM[1]/SEC-VIEW[1]/DIV[1]/INPUT[1]'
                            regular_expression: false
                          name: _xpath
                          hidden: true
                          read_only: true
                      ...
                      - property:
                          value:
                            value: ng-valid ng-scope ng-touched in-focus ng-dirty ng-valid-parse
                            regular_expression: false
                          name: class
                          hidden: true
                          read_only: true
                ...
                - object:
                    ...
                    properties:
                      ...
                      - property:
                          value:
                            value: '//DIV[@id="paymentMethod"]/DIV[1]/DIV[2]/SEC-FORM[1]/SEC-VIEW[1]/DIV[1]/INPUT[1]'
                            regular_expression: false
                          name: _xpath
                          hidden: true
                          read_only: true
                ...
                - object:
                    ...
                    properties:
                      ...
                      - property:
                          value:
                            value: '//DIV[@id="paymentMethod"]/DIV[1]/DIV[2]/SEC-FORM[1]/SEC-VIEW[2]/DIV[1]/INPUT[1]'
                            regular_expression: false
                          name: _xpath
                          hidden: true
                          read_only: true
                ...
                - object:
                    ...
                    properties:
                      ...
                      - property:
                          value:
                            value: '//LOGIN-MODAL[1]/DIV[1]/DIV[1]/DIV[3]/SEC-FORM[1]/SEC-VIEW[2]/DIV[1]/INPUT[1]'
                            regular_expression: false
                          name: _xpath
                          hidden: true
                          read_only: true
                ...
                - object:
                    ...
                    properties:
                      ...
                      - property:
                          value:
                            value: '//DIV[@id="productProperties"]/DIV[3]/BUTTON[@role="button"][1]'
                            regular_expression: false
                          name: _xpath
                          hidden: true
                          read_only: true
